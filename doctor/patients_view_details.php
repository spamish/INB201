    ...
    <body>
        <div id="wrapper">
            ...
            <div id="content"> <!-- All content goes here -->
                ...
                <div id="actions">
                    <a id="btnAction" href="transfer.php?fileID=<?php echo $file->fileID ?>">Transfer</a>
                ...
                <div id="message">
                    <?php if ($file->patient) { ?>
                        <a id="btnAction" class="history"
                            href="history.php?patientID=<?php echo $patient->patientID ?>">Patient History</a>
                    <?php } ?>
                </div>
