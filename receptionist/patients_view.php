...
<?php
    ...
    //Divider search parameters.
    {
        ...
        $patient->firstName = ($patient->firstName ? ("LIKE." . $patient->firstName) : null);
        $patient->surname = ($patient->surname ? ("LIKE." . $patient->surname) : null);
        ...
        $_GET['firstName'] = (isset($_GET['docFirstName']) ? "LIKE." . $_GET['docFirstName'] : null);
        $_GET['surname'] = (isset($_GET['docSurname']) ? "LIKE." . $_GET['docSurname'] : null);
        $_GET['gender'] = null;
        $_GET['ward'] = null;
